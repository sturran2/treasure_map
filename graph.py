...
class Graph:
  ...
  def explore(self):
    ...
    while current_room != "treasure room":
      ...
      print("\nYou have accumulated: {total} cost"
.format(total=path_total))
      choice=input("\nWhich room do you move to? ")
      if choice not in valid_choices:
        print("please select from these letters {choices}".format(valid_choices))
      else:
        ...
        print("\n*** You have chosen: {0} ***\n".format(current_room))
    print("Made it ot the treasure room with {great} cost".format(great=path_total))
